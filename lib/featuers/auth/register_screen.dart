...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void register() async {
    ...
    if (savedEmail != null && savedEmail == emailController.text.trim()) {
      ...
      await PreferencesMangar().setString("user_password", passwordController.text);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Center(child: Image.asset("assets/images/logo.png", height: AppSize.h45)),
                  SizedBox(height: 40),
                  Text(
                    'Welcome to Newts',
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Text(
                          "Sign In",
                          style: TextStyle(color: Theme.of(context).primaryColor, fontSize: AppSize.sp16),
                        ),
                      ),
                    ],
                  ),
